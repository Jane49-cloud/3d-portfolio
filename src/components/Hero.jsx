...
const Hero = () => {
  return (
    <section
      className={`relative w-full min-h-screen mx-auto  max-w-7xl mx-auto$`}
    >
      <div
      ...
      <div className=" absolute inset-0  top-[260px] md:top-[350px]  w-full   px-3  justify-between max-w-[90rem] mx-auto mt-10 flex flex-wrap gap-2 rounded-[20px] bg-opacity-100 items-center">
        ...
        <div className="bg-black-200 w-full lg:w-[20%] mt-4 p-10 rounded-[10px]  shadow-lg lg:h-[200px] flex-grow">
          ...
          <p className="text-lg font-medium ">
            "Coding is not just about commands and algorithms; it's a symphony
            of creativity and logic, where every line of code tells a story, and
            every function paints a picture of innovation."
          </p>
        ...
        <div className=" sm:mt-0 bg-none">
          <img
            src={robot}
            alt="Robot"
            className=" h-auto sm:w-64 mb-4 sm:mb-0"
          />
        </div>
      </div>
    </section>
